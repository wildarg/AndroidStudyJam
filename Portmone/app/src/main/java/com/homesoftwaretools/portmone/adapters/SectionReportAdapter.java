...
public class SectionReportAdapter extends BaseAdapter {
    ...
    public SectionReportAdapter(Context context) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Cursor c = (Cursor) getItem(position);
        int itemType = getViewType(c);
        if (view == null) {
            view = newView(context, c, parent);
        } else {
            Holder holder = (Holder) view.getTag();
            if (itemType != holder.getType())
                view = newView(context, c, parent);
        }
    ...
    private class SectionHolder implements Holder {
        TextView section;
        TextView sum;
        TextView description;
