...
public class AddIncomeAsyncTask extends ProgressAsyncTask<Income, Void, Void> {
    ...
    protected Void doInBackground(Income... params) {
        ...
        Uri uri = resolver.insert(PortmoneContract.Incomes.CONTENT_URI, income.getValues());
